(function ($) {
    $.fn.county = function (options) {
        var settings = $.extend({ endDateTime: new Date("2013/07/16 10:00:00"), animation: 'fade', reflection: true, reflectionOpacity: 0.2, speed: 500, theme: 'black' }, options);
        ...
        return this.each(function () {
            ...
            function getCurrentCountDown() {
                ...
                var endDateTime = new Date("2013/06/16 10:00:00");
